  ...
  return (
    <div className='flex justify-center items-center flex-col h-[100vh] gap-[2vw]'>
      ...
      <select className='p-[1vw] w-full rounded-md rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue="all" name="format" id="format">
        <option value={"all"} disabled>{"How can I reduce the amount of waste I produce?"}</option>
    ...
    <div className="w-[80vw]">
      <select className='p-[1vw] w-full rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue="all" name="format" id="format">
        <option value={"all"} disabled>{"What should I do with recyclable materials in my area?"}</option>
    ...
    <div className="w-[80vw]">
      <select className='p-[1vw] w-full rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue="all" name="format" id="format">
        <option value={"all"} disabled>{"Is composting feasible for me, and how do I start?"}</option>
    ...
    <div className="w-[80vw]">
      <select className='p-[1vw] w-full rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue=".w-fullall" name="format" id="format">
        <option value={"all"} disabled>{"What are some alternatives to single-use plastics?"}</option>
    ...
    <div className="w-[80vw]">
      <select className='p-[1vw] w-full rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue="all" name="format" id="format">
        <option value={"all"} disabled>{"How can I properly dispose of electronic waste (e-waste)?"}</option>
    ...
    <div className="w-[80vw]">
      <select className='p-[1vw] w-full rounded-md shadow-[0_10px_20px_rgba(8,_112,_184,_0.7)]' defaultValue="all" name="format" id="format">
        <option value={"all"} disabled>{"Are there any local programs or facilities for hazardous waste disposal?"}</option>
