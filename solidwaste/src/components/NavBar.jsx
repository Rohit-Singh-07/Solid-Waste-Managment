...
function NavBar() {
  return (
    <div className="flex justify-center items-center w-[100vw] py-[1.5vw]">
      <div className="bg-zinc-900 sm:w-[40vw] w-[80vw] z-10 flex justify-around items-center h-[6vh] rounded-2xl text-zinc-400 shadow-[8px_8px_40px_3px_#4359CF83] fixed top-5">
      <NavLink
        to="/"
